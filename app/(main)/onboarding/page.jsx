...
export default function OnboardingPage() {
    ...
    const checkExistingRole = async () => {
      ...
      try {
        ...
        if (data.role === "PATIENT") {
          ...
          data.role === "VERIFICATION_MANAGER"
        ) {
  ...
  // اختيار السكرتيرة
  // ==============================
  const handleSecretarySelection =
    async () => {
